...
class Node_struc_Aurora(Class_Node_struc.Node_struc):

    def get_tot(self):
        return super().get_tot()

    def get_idle(self):
        return super().get_idle()

    def get_avail(self):
        return super().get_avail()

    def is_available(self, proc_num):
        return super().is_available(proc_num)

    def import_node_config(self, config_file):
        return super().import_node_config(config_file)

    def import_node_file(self, node_file):
        return super().import_node_file(node_file)  
